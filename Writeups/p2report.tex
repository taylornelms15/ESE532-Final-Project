...
\newline
\textbf{Equations for benefit:} Ideally, for N stages, a linear increase in throughput and at higher clock speeds, thus improving on baseline CPU performance. For CDC, this is a possible approach and the chunks can be streamed into the FPGA logic. 
\newline
\newline
